...
let projects = [
  {
    image: './public/textures/project-spaze.webp',
    url: 'https://www.spaze.social/',
  },
  {
    image: './public/textures/project-myteachers.jpg',
    url: 'https://myteachers.com.au/',
  },
  {
    image: './public/textures/project-wholesale.jpg',
    url: 'https://wholesale.com.np/',
  },
  {
    image: './public/textures/project-pelotero.jpg',
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('SANJAY KUMAR', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
